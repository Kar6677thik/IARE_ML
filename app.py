...
conversation = ConversationChain(llm = chat_groq, memory = memory)
...
def generate():
    ...
    if request.method == "POST":
        ...
        prompt = PromptTemplate(input_variables=["topic"], template="Generate a short 5-question assignment on the topic: {topic}.")
